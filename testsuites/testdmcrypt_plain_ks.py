...
class TestSanity(basetest.Basetest):
    ...
    def test04_CreateInitialMons(self):
        general.updateCephConf_dmcrypt('plain', '44.0.1.42', 'ftps')
    ...
    def test06_PrepareOSDs(self):
        cephdeploy.osdPrepare(self.ctx['osd_prepare'], dmcrypt=True)

    def test07_ActivateOSDs(self):
        cephdeploy.osdActivate(self.ctx['osd_activate'], dmcrypt=True)
